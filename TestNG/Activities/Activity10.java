...
public class Activity10 {
    ...
    public static List<List<Object>> readExcel(String filePath) {
        ...
        try {
            ...
            FileInputStream file = new FileInputStream("C:/Users/002PJX744/Desktop/Python_FST/FST_Excel");
    ...
    public static Object[][] signUpInfo() {
        ...
        List<List<Object>> data = readExcel("C:/Users/002PJX744/Desktop/Python_FST/FST_Excel");
        return new Object[][] {
                { data.get(1) },
                { data.get(2) },
                { data.get(3) },
